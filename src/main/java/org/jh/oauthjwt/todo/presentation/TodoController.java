...
//    }
    ...
    public ResponseEntity<Page<TodoResponse>> getTodos(
        ...
        Page<TodoResponse> todoResponses = todoService.getAllTodos(pageable);
        return ResponseEntity.ok(todoResponses);
    }
    ...
    public ResponseEntity<List<TodoResponse>> getTodosByCategory(@PathVariable final String category) {
        final List<TodoResponse> todoResponses = todoService.getTodosByCategory(category);
        return ResponseEntity.ok(todoResponses);
    }
}